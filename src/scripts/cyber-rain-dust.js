/* global document, HTMLElement, performance, location, window */

export function initCyberRainAndDust() {
  // Injecting 70 animated nodes is pointless when the OS asks for reduced
  // motion — bail before touching the DOM rather than animating and hiding.
