...
You can configure site identity, social links, and About content from config files, then publish posts in each locale folder.

Start publishing your first post.
