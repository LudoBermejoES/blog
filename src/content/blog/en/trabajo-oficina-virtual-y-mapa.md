...
![Top-down map of the upper floor of the dockside warehouse, now with one more room: bedrooms, a library, a kitchen and an armory spread across the corners, around the large central bay divided by partition walls, with the dock and the water at the edge.](../../../assets/blog/trabajo-oficina-virtual-y-mapa-planta-arriba.webp)

I wasn't able to make any progress on the new chapter of the novel because I started work early, and that worries me: I'm finding it hard to get back into a rhythm. But it isn't something I can control either, so for now it'll have to do.
