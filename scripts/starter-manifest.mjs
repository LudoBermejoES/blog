...
export const STARTER_STATIC_MANAGED_FILES = [
  ...
  'docs/previews/preview-about.png',
  'docs/previews/preview-blog-list.png',
  'docs/previews/preview-blog-post-collapsed.png',
  'docs/previews/preview-blog-post-open.png',
  'docs/previews/preview-home.png',
